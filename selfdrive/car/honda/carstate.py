...
class CarState():
  ...
  def update(self, cp, cp_cam):
    ...
    self.angle_steers = (cp.vl["STEERING_SENSORS"]['STEER_ANGLE']) * (2*cp.vl["STEERING_SENSORS"]['STEER_ANGLE_SIGN']-1) * 0.9
    self.angle_steers_rate = (cp.vl["STEERING_SENSORS"]['STEER_ANGLE_RATE']) * (2*cp.vl["STEERING_SENSORS"]['STEER_ANGLE_RATE_SIGN']-1) * 0.9
